...
interface AppHeaderProps {
  ...
  onNavigateToGeo: () => void; // Nova prop
  onToggleHistory: () => void;
  currentView: 'dashboard' | 'form' | 'schools' | 'school_details' | 'geo'; // Adicionado 'geo'
  onPrint: () => void;
    ...
    <header className="bg-[#90EE90] p-4 sm:p-6 text-gray-800 flex justify-between items-center break-inside-avoid">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <button
            ...
            className={`flex items-center gap-2 px-3 py-2 text-sm font-medium text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#90EE90] focus:ring-white transition-colors ${currentView === 'geo' ? 'bg-emerald-900 shadow-inner' : 'bg-emerald-700 hover:bg-emerald-800'}`}
