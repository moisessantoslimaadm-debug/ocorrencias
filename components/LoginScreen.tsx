      ...
      <div className="flex w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden animate-fade-in-up">
        ...
        <div className="hidden md:block w-1/2 relative bg-gray-900">
            <img 
                ...
                onError={(e) => {
                    // Fallback to a static image of the show if the GIF fails
                    e.currentTarget.src = "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?q=80&w=2071&auto=format&fit=crop";
                    e.currentTarget.alt = "Imagem da Escola";
                }}
            />
